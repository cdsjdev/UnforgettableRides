...
const buildShaRaw = process.env.GIT_SHA || process.env.COMMIT_SHA || 'unknown';
const buildSha = buildShaRaw === 'unknown' ? buildShaRaw : buildShaRaw.slice(0, 7);
const buildNumber = process.env.BUILD_NUMBER || process.env.RELEASE_NUMBER || process.env.RELEASE_VERSION || 'dev';
