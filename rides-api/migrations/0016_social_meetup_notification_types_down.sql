...
CREATE TABLE social_notifications (
  ...
  object_type   TEXT NULL
                CHECK(object_type IS NULL OR object_type IN ('post', 'comment', 'thread', 'follow')),
  object_id     TEXT NULL,
...
WHERE type IN ('like', 'comment', 'follow', 'follow_accepted', 'message')
  AND (object_type IS NULL OR object_type IN ('post', 'comment', 'thread', 'follow'));
