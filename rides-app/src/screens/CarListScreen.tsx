...
const styles = StyleSheet.create({
  ...
  tagFilter: { borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 6 },
  tagFilterActive: { backgroundColor: GOLD, borderColor: GOLD },
  tagFilterText: { color: '#a09070', fontSize: 13, textTransform: 'capitalize' },
